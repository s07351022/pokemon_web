...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <footer class="row row-cols-5 py-5 my-5 border-top">
    ...
    <div class="col col_void">
      
    </div>
  
    <div class="col">
    <ul class="list-unstyled d-flex">
      <li class="ms-3"><a class="text-muted" href="https://asia.pokemon-card.com/tw/"><svg class="bi" width="24" height="24"><use xlink:href="#pokemon"/></svg></a></li>
      <li class="ms-3"><a class="text-muted" href="https://www.facebook.com/Pokemon.TCG.Official.Taiwan/"><svg class="bi" width="24" height="24"><use xlink:href="#facebook"/></svg></a></li>
    </ul>
    <ul class="list-unstyled d-flex">
      <li class="ms-3"><a class="text-muted" href="https://www.youtube.com/channel/UCCI-s2RRbUVPUEKVCcgil_g"><svg class="bi" width="24" height="24"><use xlink:href="#youtube"/></svg></a></li>
      <li class="ms-3"><a class="text-muted" href="https://www.tiktok.com/@pokemon?_d=secCgYIASAHKAESMgowH9laQNMwBVi9gtaHGWG%2BgC%2F60wRmNDr567n%2FSVZOkzREyYGQiAb7blJDWXb2lbAaGgA%3D&checksum=3d7e80ac6f17c03911908f79a8f76727cbd51f64a41acd7e01b4ed41dd3fee44&language=ja&sec_uid=MS4wLjABAAAAa1fJSjZKTApETVa8SJVG3RxNnDxZZquqeRUk2-_w6LrDXePBSqbhk6rM3v1ipPs3&sec_user_id=MS4wLjABAAAAa1fJSjZKTApETVa8SJVG3RxNnDxZZquqeRUk2-_w6LrDXePBSqbhk6rM3v1ipPs3&share_app_id=1180&share_author_id=6978593801373205505&share_link_id=9858BC6F-B92B-4E6B-AE44-EC4695AD5781&tt_from=copy&u_code=dja54a43b2m15m&user_id=6978593801373205505&utm_campaign=client_share&utm_medium=ios&utm_source=copy&source=h5_t&_r=1"><svg class="bi" width="24" height="24"><use xlink:href="#tiktok"/></svg></a></li>
    </ul>
    </div>
    ...
    <div class="col">
      ...
      <ul class="nav flex-column">
        <li class="nav-item mb-2"><a href="https://shopee.tw/search?keyword=%E5%AF%B6%E5%8F%AF%E5%A4%A2%E5%8D%A1%E7%89%8C" class="nav-link p-0 text-muted footer_color">蝦皮購物</a></li>
        <li class="nav-item mb-2"><a href="https://www.ruten.com.tw/find/?q=%E5%AF%B6%E5%8F%AF%E5%A4%A2%E5%8D%A1%E7%89%8C" class="nav-link p-0 text-muted footer_color">露天拍賣</a></li>
        <li class="nav-item mb-2"><a href="https://paipaizhan.com.tw/cardgame-ptcg/" class="nav-link p-0 text-muted footer_color">牌牌戰</a></li>
      </ul>
    </div>
    ...
    <div class="col">
      <h5>快速連結</h5>
      <ul class="nav flex-column">
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted footer_color">關於我們</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted footer_color">最新消息</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted footer_color">快速查詢</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted footer_color">價格排行</a></li>
      </ul>
    </div>
    ...
    <div class="col">
      <h5>聯繫我們</h5>
      <ul class="nav flex-column">
        <li class="nav-item mb-2 footer_color">s06610227@go.thu.edu.tw</li>
        <li class="nav-item mb-2 footer_color">s07351008@go.thu.edu.tw</li>
        <li class="nav-item mb-2 footer_color">s07351022@go.thu.edu.tw</li>
        <li class="nav-item mb-2 footer_color">s07351044@go.thu.edu.tw</li>
      </ul>
    </div>
  </footer>
</body>
